...
- `Coordinator Agent`
  负责任务拆解、接口契约、Git 规则、AGENTS 维护、集成验证和 GitHub 流程推进。
...
Browser
  ...
  -> Local Storage (data/ + checkpoints/)
```
